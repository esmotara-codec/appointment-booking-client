        ...
        <div className='bg-white min-h-screen text-black'>
            ...
            <div className=' container mx-auto  md:p-10 py-3  text-center items-center '>
                <div className='flex flex-col justify-center items-center  gap-3'>
                    ...
                    <Link to={'/'}> <button className='btn bg-[#0EA106] text-white border border-[#0EA106]/20 text-center  md:text-xl font-semibold px-5 md:px-10 py-2 rounded-s-md shadow-none '>Go Back Home</button>
