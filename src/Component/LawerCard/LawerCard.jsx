				...
				<div className='w-2/3'>
					<div>
						<div className='flex flex-row gap-2 mb-2'>
							<button className='bg-[#09982F]/10 text-green-600 px-4 py-1 rounded-full text-sm '>
								{status}
							</button>
						...
						<Link to={`/lawerdetails/${id}`}>
							<button className='btn bg-white border w-full  border-[#176AE5]/20 text-center text-[#176AE5] px-10 py-2 rounded-full shadow-none '>
								View details
							</button>
						</Link>
					</div>
